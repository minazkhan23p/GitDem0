...
public class calender {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> dates = driver.findElements(By.cssSelector("div.dateInnerCell p"));
		while(!driver.findElements(By.cssSelector(".DayPicker-Caption")).get(0).getText().contains("February")) {
